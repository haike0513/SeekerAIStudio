export default {
  app: {
    ...
    settings: {
      ...
      features: {
        title: "Feature Modules Settings",
        description: "Enable or disable various feature modules of the application",
        inference: "AI Inference",
        inferenceDescription: "Local model inference functionality",
        chat: "AI Chat",
        chatDescription: "Chat with AI models",
        workflow: "Workflow",
        workflowDescription: "Create and manage AI inference workflows",
        novel: "Novel Creation",
        novelDescription: "AI-assisted novel writing functionality",
        comic: "Comic Creator",
        comicDescription: "AI-assisted comic creation functionality",
        audio: "Audio Studio",
        audioDescription: "AI audio generation and processing functionality",
        video: "Video Studio",
        videoDescription: "AI video generation and editing functionality",
        models: "Model Management",
        modelsDescription: "Manage local and remote AI models",
        history: "History",
        historyDescription: "View and manage history records",
      },
      chat: {
        title: "AI Chat",
